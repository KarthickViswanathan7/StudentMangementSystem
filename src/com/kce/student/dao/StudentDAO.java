...
public class StudentDAO {
 ...
 public void addStudent(Student student) throws DuplicateKeyException, SQLException{
     ...
     statement.close();
		 ...
		 throw new DuplicateKeyException("ID already exists, please provide a unique id");
	 }
 ...
 public void displayAllStudents() throws SQLException {
	// try {
     ...
     ResultSet resultSet = statement.executeQuery("SELECT students.student_id,students.name,students.age,grades.grade FROM students JOIN grades on students.student_id=grades.student_id  order by student_id;");
 ...
 public void searchStudent(int RollNo) throws SQLException, studentNotFoundException {
	 try {
     ...
     while (resultSet1.next()) {
    	 String grade;
         grade = resultSet1.getString("grade");
         System.out.println("Grade: " + grade);
     }
	 }
	 catch (studentNotFoundException e) {
 ...
 public void updateGrade(Student student) throws SQLException, studentNotFoundException{
     PreparedStatement statement = connection.prepareStatement(
